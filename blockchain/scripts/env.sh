...
export FABRIC_CA_CLIENT_ID_AFFILIATION=org1 # Improvement: I did not understand this
...
function initOrgVars {
   ...
   ROOT_CA_HOST=rca-org0
   ROOT_CA_NAME=rca-org0
   ...
   ROOT_CA_ADMIN_USER=rca-org0-admin
   ...
   ROOT_CA_CERTFILE=/${DATA}/org0-ca-cert.pem
...
function genClientTLSCert {
	 echo "Usage: TLS is not used in this network"
}
